...
The GUI SHALL display an info panel with graph statistics: node count, edge count, clause count, and community statistics (when available).
...
- **WHEN** community detection produces 4 communities with Q = 0.42
- **THEN** the info panel shows "Communities: 4", "Q modularity: 0.42", and size distribution
